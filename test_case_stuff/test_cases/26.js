...
const landmark_address2 = '51 Astor Pl, New York, NY 10003, USA';

module.exports = {
    active: true,
  description: "implicit negation (replacement value provided for address), landmark address replaced by regular, street address",
  test: [
    {
    ...
    },
    {
      ...
      output: responses.get("confirm-address")
        .replace('<? context.address ?>', landmark_address2)
    },
    {
      input: "that's right",
