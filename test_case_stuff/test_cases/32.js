...
const landmark_address3 = '233 Broadway, New York, NY 10007, USA';

module.exports = {
  active: true,
  description: "Address Failure limit test - Implicit negation of landmark address",
  test: [
    {
    ...
    {
      input: "woolworth building",
      output: responses.get("confirm-address-landmark")
          .replace('<? context.landmark_address ?>', landmark_address3)
          .replace('<? context.landmark_friendly ?>', landmarks.get('woolworth_building'))
    },
    {
      input: "plaza hotel",
